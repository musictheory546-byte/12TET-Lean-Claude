...
%% ---- TwelveTET → MajorMinor (horizontal) ----
...
\lstinputlisting[
  firstline=55, lastline=66, firstnumber=55,
...
\lstinputlisting[
  firstline=69, lastline=73, firstnumber=69,
...
\lstinputlisting[
  firstline=76, lastline=111, firstnumber=76,
...
\lstinputlisting[
  linerange={114-120,122-127,129-132}, firstnumber=114,
...
\lstinputlisting[
  linerange={135-142,144-156}, firstnumber=135,
...
\lstinputlisting[
  firstline=159, lastline=169, firstnumber=159,
...
\lstinputlisting[
  linerange={28-30,32-37,39-55,58-70,72-74}, firstnumber=28,
...
\lstinputlisting[
  linerange={79-90,92-95}, firstnumber=79,
  caption={\texttt{MajorMinor.lean}: upper bound},
  label={lst:mm-upper}
]{../Music/MajorMinor.lean}

\lstinputlisting[
  linerange={121-188,191-199,202-208}, firstnumber=121,
...
\lstinputlisting[
  linerange={11-35,37-48,50-53}, firstnumber=11,
...
\lstinputlisting[
  firstline=9, lastline=27, firstnumber=9,
...
% -----------------------------------------------------------------------
\section{Sensetivity Analysys}
\label{sec:sensetivity}
To explore the sensitivity of this proof to the axioms, to first order, we delete
each of them in turn and attempt to rescue the proof.
\subsection{Removing A1}
Without A1 to assert the existence of the tritone we would introduce a lemma to find
a suiable tritone (ie, $6$) in 12-TET model. However, we also find that in a tuning system
with an odd number of pitch-classes, and so no tritone, A2, A6 and A8 are vacuously true
and the axioms remain consistent. A 3-TET, at minimum would satisfy the remaining axioms.
% --
