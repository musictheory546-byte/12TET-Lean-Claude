...
\lstinputlisting[
  linerange={123-190,192-201,203-210}, firstnumber=123,
...
The axiom set A1--A8 is not proved consistent within Lean; the axioms are
trusted declarations.  Consistency is supported informally by the fact
that $\mathbb{Z}/12\mathbb{Z}$ with $t = 6$ and $p = 7$ satisfies all
eight axioms, but this has not been formalised as a model-construction proof.
